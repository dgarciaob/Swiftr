...
function Footer() {
  ...
  return (
    <div className="mt-10 bg-white rounded-t-3xl">
        ...
        <div className="mx-auto max-w-screen-xl">
          <div className="md:flex md:justify-between">
            ...
            >
              <Link href="#init" className="flex items-center scroll-smooth">
                <Image
                  ...
                  alt="Swiftr Logo"
                />
                <span className="font-extrabold self-center text-2xl whitespace-nowrap text-black">
                  Swiftr
                </span>
              </Link>
            </motion.div>
            <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3 font-sfpro">
              {/* <div>
                <h2 className="mb-6 text-sm font-bold text-black uppercase dark:text-white">
                  About Us
                </h2>
              ...
              <div>
                ...
                <ul className="text-black/80 dark:text-gray-400">
                  <li className="mb-4">
                    <Link
                      href="#proceso"
                      scroll
          ...
          <div className="sm:flex sm:items-center sm:justify-between bg-white">
            <span className="xl:text-sm text-xs text-black/80 sm:text-center font-sfprorounded">
              © {year}{" "}
